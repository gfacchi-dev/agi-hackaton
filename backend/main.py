...
def main():
    ...
    # Engineer the prompt
    prompt = f"""
    You are a helpful medical assistant. Your task is to generate a pre-chart summary for a physician.
    ...
    response: ChatResponse = chat(model='alibayram/medgemma:27b', messages=[
    {
        'role': 'user',
        'content': prompt,
    },
